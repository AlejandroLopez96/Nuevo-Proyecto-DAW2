 ...
 <div class="mbr-section__container container mbr-section__container--isolated">
   ...
   if(isset($_GET['success'])) {
     echo '<div class="alert alert-dismissible alert-success">
       <strong>Compleato!</strong> la categoría ' . $categorias[$_GET['id']]['nombre'] . ' ha sido editada.
     </div>';
   }
           ...
           <form class="form-horizontal" action="?view=categorias&mode=edit&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded">
             <fieldset>
               <div class="form-group">
                 ...
                 <div class="col-lg-10">
                   <input type="text" class="form-control" name="nombre" placeholder="Nombre para la categoría" value="<?php echo $categorias[$_GET['id']]['nombre']; ?>">
                 </div>
               </div>
               <div class="form-group">
